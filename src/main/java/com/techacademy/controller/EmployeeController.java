...
public class EmployeeController {
	...
	public String add(@Validated Employee employee, BindingResult res, Model model) {
		...
		try {
			ErrorKinds result = employeeService.save(employee, false, true);
	...
	public String saveEmployee(@PathVariable("code") String code, @Validated Employee employee, BindingResult res,
			Model model) {
		if (res.hasErrors()) {
		...
		try {
			ErrorKinds result = employeeService.save(employee, true, passcheck);
